...
const cliArgs = yargs(process.argv.slice(2))
    ...
    .option('minStartDelay', { type: 'number', describe: 'Minimum random delay before starting the script in milliseconds (default 0)' })
    .option('maxStartDelay', { type: 'number', describe: 'Maximum random delay before starting the script in milliseconds (default 0)' })
    .option('minRequestDelay', { type: 'number', describe: 'Minimum random delay between clip requests in milliseconds (default 1000)' })
    .option('maxRequestDelay', { type: 'number', describe: 'Maximum random delay between clip requests in milliseconds (default 5000)' })
    .help()
    .parseSync()
